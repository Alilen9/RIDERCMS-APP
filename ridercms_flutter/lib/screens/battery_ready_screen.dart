            ...
            children: [
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const Text('Battery Ready!', style: TextStyle(color: kTextPrimary, fontSize: 20, fontWeight: FontWeight.w700)),
                      ],
                    ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [kPrimary.withOpacity(0.2), kPrimaryDark.withOpacity(0.1)],
                        ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const Text('Charged Batteries', style: TextStyle(color: kTextPrimary, fontSize: 15, fontWeight: FontWeight.w600)),
                                ...
                                Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: const Text('✅ 100%', style: TextStyle(color: kPrimary, fontSize: 11, fontWeight: FontWeight.w600)),
                                    ),
                                    const SizedBox(height: 4),
                                    Text(battery['chargeTime']!, style: const TextStyle(color: kTextSecondary, fontSize: 11)),
                                  ],
                                ),
                              ],
                            ),
                        ...
                        children: [
                          ...
                          const Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Westlands Station', style: TextStyle(color: kTextPrimary, fontSize: 13, fontWeight: FontWeight.w600)),
                                SizedBox(height: 2),
                                Text('Westlands Rd, Nairobi · Open until 10 PM', style: TextStyle(color: kTextSecondary, fontSize: 11)),
                              ],
                            ),
                          ),
                          const Text('Directions', style: TextStyle(color: kPrimary, fontSize: 13, fontWeight: FontWeight.w600)),
                        ],
                      ),
                    ),
                    const SizedBox(height: 12),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Collection Reminder', style: TextStyle(color: kWarning, fontSize: 13, fontWeight: FontWeight.w600)),
                                SizedBox(height: 4),
                                Text(
